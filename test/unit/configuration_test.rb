...
class ConfigurationTest < ActiveSupport::TestCase
  test "read configuration from default file" do
    ...
    assert 1, configuration.schedulers.count
  end
  ...
  test "provide configuration as a hash and fill defaults" do
    ...
    assert_equal SolidQueue::Configuration::SCHEDULER_DEFAULTS[:polling_interval], configuration.schedulers.first.polling_interval
    assert_equal 2, configuration.workers.count
