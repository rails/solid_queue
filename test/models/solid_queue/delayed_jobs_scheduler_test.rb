...
class SolidQueue::DelayedJobsSchedulerTest < ActiveSupport::TestCase
  include ActiveSupport::Testing::MethodCallAssertions

  setup do
    @scheduler = SolidQueue::Scheduler::DelayedJobsScheduler.new(polling_interval: 0.1, batch_size: 10)
  end
  ...
  test "run more than one instance of the scheduler" do
    ...
    another_scheduler = SolidQueue::Scheduler::DelayedJobsScheduler.new(polling_interval: 0.1, batch_size: 10)
    @scheduler.start(mode: :async)
